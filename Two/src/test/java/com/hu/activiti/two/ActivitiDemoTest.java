...
import com.hu.activiti.two.entity.Person;
import com.hu.activiti.two.service.ActivityDemoServiceImpl;
...
@SpringBootTest(classes = TwoApplication.class)
@WebAppConfiguration
public class ActivitiDemoTest {
	...
	public void completeTasksForSL() {
		activityDemoServiceImpl.completeTask("12510", "sly1", "true");//受理后，任务列表数据减少
	}
